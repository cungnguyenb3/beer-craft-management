...
class PassportResourceIT {
    ...
    private static final Instant DEFAULT_ADDTION_TIME = Instant.ofEpochMilli(0L);
    private static final Instant UPDATED_ADDTION_TIME = Instant.now().truncatedTo(ChronoUnit.MILLIS);
    ...
    public static Passport createEntity(EntityManager em) {
        Passport passport = new Passport().addtionTime(DEFAULT_ADDTION_TIME);
        return passport;
    }
    ...
    public static Passport createUpdatedEntity(EntityManager em) {
        Passport passport = new Passport().addtionTime(UPDATED_ADDTION_TIME);
        return passport;
    }
    ...
    void createPassport() throws Exception {
        ...
        assertThat(testPassport.getAddtionTime()).isEqualTo(DEFAULT_ADDTION_TIME);
    }
    ...
    void getAllPassports() throws Exception {
        ...
        restPassportMockMvc
            ...
            .andExpect(jsonPath("$.[*].addtionTime").value(hasItem(DEFAULT_ADDTION_TIME.toString())));
    }
    ...
    void getPassport() throws Exception {
        ...
        restPassportMockMvc
            ...
            .andExpect(jsonPath("$.addtionTime").value(DEFAULT_ADDTION_TIME.toString()));
    }
    ...
    void putNewPassport() throws Exception {
        ...
        updatedPassport.addtionTime(UPDATED_ADDTION_TIME);
        ...
        Passport testPassport = passportList.get(passportList.size() - 1);
        assertThat(testPassport.getAddtionTime()).isEqualTo(UPDATED_ADDTION_TIME);
    }
    ...
    void fullUpdatePassportWithPatch() throws Exception {
        ...
        partialUpdatedPassport.addtionTime(UPDATED_ADDTION_TIME);
