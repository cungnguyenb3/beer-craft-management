...
class CategoryResourceIT {
    ...
    public static Category createEntity(EntityManager em) {
        Category category = new Category().jobTitle(DEFAULT_JOB_TITLE).description(DEFAULT_DESCRIPTION);
        return category;
    }
    ...
    public static Category createUpdatedEntity(EntityManager em) {
        Category category = new Category().jobTitle(UPDATED_JOB_TITLE).description(UPDATED_DESCRIPTION);
        return category;
    }
    ...
    void createCategory() throws Exception {
        ...
        assertThat(testCategory.getJobTitle()).isEqualTo(DEFAULT_JOB_TITLE);
    ...
    void putNewCategory() throws Exception {
        ...
        updatedCategory.jobTitle(UPDATED_JOB_TITLE).description(UPDATED_DESCRIPTION);
        ...
        Category testCategory = categoryList.get(categoryList.size() - 1);
        assertThat(testCategory.getJobTitle()).isEqualTo(UPDATED_JOB_TITLE);
    ...
    void partialUpdateCategoryWithPatch() throws Exception {
        ...
        partialUpdatedCategory.jobTitle(UPDATED_JOB_TITLE);
    ...
    void fullUpdateCategoryWithPatch() throws Exception {
        ...
        partialUpdatedCategory.jobTitle(UPDATED_JOB_TITLE).description(UPDATED_DESCRIPTION);
