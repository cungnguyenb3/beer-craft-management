...
import com.formos.craft.domain.Country;
import com.formos.craft.repository.CountryRepository;
...
class CountryResourceIT {
    ...
    public static Country createEntity(EntityManager em) {
        Country country = new Country().countryName(DEFAULT_COUNTRY_NAME).countryCode(DEFAULT_COUNTRY_CODE).phoneCode(DEFAULT_PHONE_CODE);
        return country;
    }
    ...
    public static Country createUpdatedEntity(EntityManager em) {
        Country country = new Country().countryName(UPDATED_COUNTRY_NAME).countryCode(UPDATED_COUNTRY_CODE).phoneCode(UPDATED_PHONE_CODE);
        return country;
    }
    ...
    void putNewCountry() throws Exception {
        ...
        updatedCountry.countryName(UPDATED_COUNTRY_NAME).countryCode(UPDATED_COUNTRY_CODE).phoneCode(UPDATED_PHONE_CODE);
    ...
    void partialUpdateCountryWithPatch() throws Exception {
        ...
        partialUpdatedCountry.countryName(UPDATED_COUNTRY_NAME).countryCode(UPDATED_COUNTRY_CODE).phoneCode(UPDATED_PHONE_CODE);
