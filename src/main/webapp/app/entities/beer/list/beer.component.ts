...
export class BeerComponent implements OnInit {
  ...
  trackId(_index: number, item: IBeer): number {
    return item.id!;
  }
  ...
  protected onSuccess(data: IBeer[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
