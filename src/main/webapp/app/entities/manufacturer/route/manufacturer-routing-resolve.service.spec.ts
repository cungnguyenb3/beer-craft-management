...
describe('Manufacturer routing resolve service', () => {
  ...
  let resultManufacturer: IManufacturer | undefined;
  ...
  describe('resolve', () => {
    ...
    it('should return new IManufacturer if id is not provided', () => {
      // GIVEN
      ...
      expect(resultManufacturer).toEqual(new Manufacturer());
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse({ body: null as unknown as Manufacturer })));
      mockActivatedRouteSnapshot.params = { id: 123 };
