...
export class PassportUpdateComponent implements OnInit {
  ...
  protected updateForm(passport: IPassport): void {
    this.editForm.patchValue({
      id: passport.id,
      addtionTime: passport.addtionTime ? passport.addtionTime.format(DATE_TIME_FORMAT) : null,
  ...
  protected createFromForm(): IPassport {
    return {
      ...
      addtionTime: this.editForm.get(['addtionTime'])!.value
        ? dayjs(this.editForm.get(['addtionTime'])!.value, DATE_TIME_FORMAT)
        : undefined,
